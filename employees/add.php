...
if(isset($_GET['cha'])){
    ...
    header('location: /Bank/employees/add.php');
}
if(isset($_POST['send'])){
  $name = $_POST['name'];
  $email = $_POST['email'];
...
testMessage($i, "Insert employeess");
}
...
?>
<?php if($noc == '1') : ?>
<a href="/Bank/employees/add.php?cha=2" name="cha" class="btn btn-dark">Dark mood</a>
<?php else : ?>
<a href="/Bank/employees/add.php?cha=1" name="cha" class="btn btn-light">Light mood</a>
<?php endif ; ?>
    <div class="home">
    <?php if($update):?>
    <h1 class="display-1 text-center text-info">Update employeess</h1>
    <?php else :?>
    <h1 class="display-1 text-center text-info">Add employeess</h1>
    <?php endif; ?>
  </div>
